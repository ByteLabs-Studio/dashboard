...
export default function HomePage() {
  const { theme: ntTheme, resolvedTheme } = useTheme();
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)]">
      ...
      <div
        className={`relative flex-grow transition-opacity duration-300 ${
            ...
            <div className="flex flex-col md:flex-row items-start justify-center h-full gap-8 px-6">
              <div className="w-full md:w-1/2 text-center md:text-left select-none">
                ...
                <p className="text-lg text-muted-foreground mb-3 select-none">
                  Code. Sound. Visualize — ByteLabs is an App made with Electron
                  designed to create Music or just Audio in general just by
                  using Bytes.
                </p>
            ...
            <div className="space-y-8 max-w-3xl mx-auto">
              <div className="flex items-start p-6 rounded-lg bg-card/50 backdrop-blur-sm border border-border/50 hover:border-primary/30 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Byte beats work by using short programs that generate audio
                    as a function of time, typically producing sound in a loop.
                    These programs use mathematical operations to create musical
                    patterns, with each output representing a sample of sound
                    played at specific intervals.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 rounded-lg bg-card/50 backdrop-blur-sm border border-border/50 hover:border-primary/30 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    The magic comes from <strong>bitwise operations</strong>{" "}
                    (like <code>&amp;</code>, <code>|</code>, <code>^</code>,{" "}
                    <code>~</code>, <code>&lt;&lt;</code>, <code>&gt;&gt;</code>
                    ) applied to a simple counter variable. These operations
                    manipulate the binary data in unique ways, turning the
                    counter into intricate, often musical patterns. This is what
                    gives Bytebeats their distinctive glitchy, 8-bit sound.
                    However, if you change the type of counter or use different
                    kinds of operations—for example, using floating-point math
                    instead of integers—you get a variation known as{" "}
                    <strong>Floatbeat</strong>, which can produce smoother or
                    more fluid sounds.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 rounded-lg bg-card/50 backdrop-blur-sm border border-border/50 hover:border-primary/30 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    ByteLabs aims to capture the simplicity of Bytebeats and the
                    creative power of bitwise operations in a user-friendly
                    application that is both intuitive and accessible. Inspired
                    by{" "}
                    <a
                    ...
                    , ByteLabs expands on the concept by offering an offline
                    experience designed for creators who want to experiment,
                    compose, and explore sound without limitations.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 rounded-lg bg-card/50 backdrop-blur-sm border border-border/50 hover:border-primary/30 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    From simple beeps to intricate musical patterns, the
                    possibilities are virtually limitless. You can blend
                    different formulas, experiment with effects, and craft
                    evolving soundscapes that grow and change over time.
                  </p>
                </div>
              </div>
            </div>
